...
Handoff: implementation and 45 focused tests complete; independent review found and
...
CodeRabbit feedback added atomic non-replacing activation publication, disconnect-failure
receipts, a fresh remote-main installer check and coverage of the spring DST boundary.
