...
logging failure cannot advance another terminal state before the next daily invocation. The
unbound wrapper runs a separate startup custody preflight and retries only its exact Git
